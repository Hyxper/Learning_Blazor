...
namespace ShopOnline.API.Data
{
    ...
    {
        //need tp inherit from dbContext
        public ShopOnlineDbContext(DbContextOptions<ShopOnlineDbContext> options) : base(options)
        {
            //constructor that was created by copilot. This allows us to pass in options to our base class

        }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            //this is an overload so we can seed our database (event that happens we when create the db model)
            base.OnModelCreating(modelBuilder);

            //Products - this is the information we are using to seed our database with products.
            //Beauty Category
        ...
        //we meed to tell efcore about our entites. We need to approiately do this with public entities of type DbSet.
